...
b+"']").length&&0===d.find("footer").find("a").filter("[href='#"+b+"']").length)){var e=d.find("footer").find("a").removeClass("pressed").attr("data-ignore-pressed","true");e.filter("[href='"+b+"']").addClass("pressed");e.filter("[href='#"+b+"']").addClass("pressed")}},showBackButton:function(a,b){var e=this.views[a.prop("id")].length,f=a.children("header");0!==f.length&&(2<=e&&!0!==b?1!==f.find(".backButton").length&&f.prepend("<a class='backButton back'> </a>"):f.find(".backButton").remove())},
